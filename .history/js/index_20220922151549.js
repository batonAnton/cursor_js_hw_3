...
document.writeln(' <br> Функія 6...У слові   -  ${countLetter()}  ${countLetter()} ');
document.writeln(`<br> Функція №7: 1000 гривень в доларах буде ${countLetter()} - ${convertCurrency(typeValue)}....`); 
