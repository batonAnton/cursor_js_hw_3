...
// 9 task
//  function getRandomPassword(arg){
//   let result;
//     // if(arg == 4){
//       // for(let i = 0; i < 4; i++){
//       //   result += i;
...
//  document.writeln(`<br> Функція №9: Пароль із  4 цифр становить - ${getRandomPassword(arg)}....`);
let result5 = "";
 
 for(let i = 1; i <= 4; i++){
  
  result5 +=  Math.random(i];
  // debugger; Math.random(i).toFixed(2);
